...
const segmentsData: SegmentData[] = [
  ...
  },
  {
    ...
    headline: "Conecte sua comunidade",
    subheadline: "Comunicação clara para membros e associados.",
    useCases: [
      { title: "Reuniões e assembleias", description: "Convocações documentadas" },
      { title: "Eventos sociais", description: "Festas e confraternizações" },
      { title: "Benefícios e parcerias", description: "Novidades para membros" },
      { title: "Comunicados da diretoria", description: "Decisões e informes" },
    ],
    ctaText: "Sou Presidente",
  },
  {
    id: "church",
    icon: Church,
  ...
  },
  {
    ...
    icon: Store,
    label: "Franquias",
    headline: "Rede alinhada, resultados melhores",
    subheadline: "Comunicação padronizada para todas as unidades.",
    useCases: [
      { title: "Comunicados da matriz", description: "Diretrizes e novidades" },
      { title: "Operações e processos", description: "Padronização de procedimentos" },
      { title: "Campanhas promocionais", description: "Marketing e vendas" },
