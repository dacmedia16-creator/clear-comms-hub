...
import {
  ...
  Edit3, Send, Eye, Shield, Lock, UserX, X, Info, Calendar, AlertTriangle,
} from "lucide-react";
...
export default function IgrejasLandingPage() {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-6">
                Comunicação oficial da igreja,{" "}
                <span className="text-primary">clara e organizada.</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed">
                Avisos em timeline única. WhatsApp e e-mail só lembram.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-6">
                <Button asChild size="lg" className="touch-target text-base font-semibold px-8">
                  <Link to="/auth/signup/church">Criar canal oficial da igreja<ArrowRight className="w-5 h-5 ml-2" /></Link>
                </Button>
              </div>
              ...
              <div className="relative">
                <div className="bg-card rounded-3xl shadow-2xl border border-border p-4 mx-auto max-w-sm">
                  <div className="bg-muted rounded-2xl p-4 space-y-4">
                    <div className="text-center pb-3 border-b border-border">
                      <h3 className="font-display font-bold text-lg">Igreja Nova Aliança</h3>
                      <p className="text-sm text-muted-foreground">Canal Oficial</p>
                    </div>
                    {[
                      { type: "informativo", title: "Agenda Semanal", subtitle: "Cultos e reuniões desta semana" },
                      { type: "evento", title: "Evento Especial", subtitle: "Sábado, às 19h" },
                      { type: "urgente", title: "Comunicado Importante", subtitle: "Mudança de horário" },
                    ].map((a, i) => {
                      const s = { informativo: { bg: "bg-blue-100", icon: "text-blue-600", badge: "bg-blue-100 text-blue-700", label: "Informativo" }, evento: { bg: "bg-purple-100", icon: "text-purple-600", badge: "bg-purple-100 text-purple-700", label: "Evento" }, urgente: { bg: "bg-red-100", icon: "text-red-600", badge: "bg-red-500 text-white", label: "Urgente" } }[a.type]!;
                      return (
                ...
                <div className="absolute -right-4 top-1/4 bg-card rounded-xl shadow-lg border border-border p-3 max-w-[200px] hidden md:block">
                  <div className="flex items-center gap-2">
                    ...
                    <div><p className="text-xs font-medium">WhatsApp enviado!</p><p className="text-xs text-muted-foreground">85 membros</p></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container px-4 mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">O pastor conhece bem{" "}<span className="text-primary">esses problemas</span></h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              { icon: MessageSquareOff, title: "Avisos de cultos se perdem", desc: "Programações e convites somem em grupos lotados de mensagens." },
              { icon: EyeOff, title: "Membros dizem que não viram", desc: "Mudanças de horário e eventos importantes não chegam a todos." },
              { icon: RefreshCw, title: "Comunicação espalhada", desc: "Informações circulam em vários grupos diferentes, sem centralização." },
            ].map((item) => (
          ...
          <p className="text-center text-muted-foreground mt-10 max-w-lg mx-auto">A igreja precisa de uma{" "}<span className="font-semibold text-foreground">fonte oficial de informação.</span></p>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { num: "03", icon: Eye, title: "Membros consultam", desc: "A informação fica disponível na linha do tempo a qualquer momento." },
            ].map((step) => (
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container px-4 mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              { title: "Agenda sempre acessível", desc: "Cultos, eventos e programações ficam registrados em um só lugar." },
              { title: "Membros bem informados", desc: "Mudanças de horário e comunicados importantes chegam a todos." },
              { title: "Histórico organizado", desc: "Cada aviso com data e categoria. Fácil de consultar quando precisar." },
              { title: "Menos ligações e dúvidas", desc: "Quando a informação está disponível, as perguntas repetidas diminuem." },
            ].map((b) => (
      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-lg text-muted-foreground">Veja como ficam os comunicados na linha do tempo da igreja.</p>
          </div>
          <div className="max-w-2xl mx-auto space-y-4">
            {[
              { cat: "informativo", label: "Informativo", title: "Agenda semanal", time: "Hoje, 08:00", content: "Culto de quarta às 19h30. Ensaio do coral às 20h30. Reunião de líderes sábado às 9h." },
              { cat: "evento", label: "Evento", title: "Evento especial de louvor", time: "Ontem, 10:00", content: "Noite de louvor e adoração neste sábado, às 19h. Traga sua família e amigos." },
              { cat: "urgente", label: "Urgente", title: "Mudança de horário do culto", time: "10/02", content: "O culto de domingo será às 10h (e não às 9h) devido a manutenção no templo." },
            ].map((a) => {
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="rounded-2xl border-2 border-primary bg-card p-8 shadow-md">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                {["Linha do tempo oficial da igreja", "Categorizado por tipo de aviso", "Histórico completo e acessível", "Acesso sem login para membros"].map((t) => (
      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">Privacidade dos membros</h2>
            <p className="text-lg text-muted-foreground">Transparência em cada comunicação.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { icon: Shield, title: "Apenas avisos oficiais", desc: "Contatos usados exclusivamente para enviar comunicados importantes da igreja." },
              { icon: Lock, title: "Sem propaganda", desc: "Nenhum dado é compartilhado com terceiros. Sem envio de publicidade." },
              { icon: UserX, title: "Descadastro a qualquer momento", desc: "Qualquer membro pode optar por não receber mais notificações quando quiser." },
            ].map((item) => (
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container px-4 mx-auto text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">Pronto para organizar a comunicação da sua igreja?</h2>
